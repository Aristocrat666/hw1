...
public class Main extends Application {
    ...
    @Override
    public void start(Stage primaryStage) throws Exception{  //окно
        Parent root = FXMLLoader.load(getClass().getResource("sample.fxml")); // компоненты
        primaryStage.setTitle("Chat"); // заголовок
        primaryStage.setScene(new Scene(root, 300, 275)); //сцена, размеры
